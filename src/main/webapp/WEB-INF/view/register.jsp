    ...
    <form:form method="post" action="register" id="registerform">
        <div class="form-content">
            ...
            <div class="input">
                ...
                <input value="${lastname}" type="text" class="form-control" id="lastname" placeholder="Enter last name"
            ...
            <div class="input">
                ...
                <input type="password" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{6,}$" class="form-control"
                       id="confirm_password" placeholder="Repeat password" name="confirmPassword" required>
            </div>
